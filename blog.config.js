...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Eason's Blog', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || 'Eason's Life', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.easonq.com', // 网站地址
